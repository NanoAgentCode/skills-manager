...
```powershell
cd .\skills\market-intelligence\stock-analysis-system\scripts
...
```powershell
.\scripts\run-python.ps1 .\skills\market-intelligence\stock-analysis-system\scripts\test_us_markets.py
```
