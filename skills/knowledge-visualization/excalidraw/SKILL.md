...
License: MIT. This local copy is integrated under `skills/knowledge-visualization/excalidraw/`.
...
**Explicit request phrases:** user says "画图", "diagram", "visualize", "flowchart", "draw", "架构图", "流程图"
