...
def validate_console_admin_skill(v: Validator) -> None:
    text = validate_skill_frontmatter(
        v,
        "dify/dify-console-admin-api/SKILL.md",
...
def validate_dsl_app_builder_skill(v: Validator) -> None:
    skill_dir = v.require_dir("dify/dify-dsl-app-builder")
    text = validate_skill_frontmatter(
        v,
        "dify/dify-dsl-app-builder/SKILL.md",
    ...
    admin_ref = "dify/dify-console-admin-api/SKILL.md"
...
def validate_readme_dify_paths(v: Validator) -> None:
    ...
    for relative_path in [
        ...
        "dify/dify-dsl-app-builder/dsl-import-rules.md",
    ]:
...
def validate_sample_workflow(v: Validator) -> None:
    workflow_path = v.require_file("dify/context-json-validator-workflow.yml")
